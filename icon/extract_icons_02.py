...
OUT=ROOT/'icons02'
src=Image.open(OUT/'01.png').convert('RGBA')
...
xs=[40,255,486,717,948,1178,1409]
ys=[20,243,436,630,825,1050]
...
preview.save(ROOT/'icons02_preview.png')
(ROOT/'icons02_validation.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
